...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h2>Documentos del contrato: {{ $contrato->colaborador->primer_nombre }} {{ $contrato->colaborador->primer_apellido }} <br>
                        {{ $contrato->informacionAdicional->cargo }} / {{ $contrato->inicio_contrato }} / {{ $contrato -> finalizacion_contrato }}</h2>
    ...
    @if($documentos->isEmpty())
        <div class="alert alert-info">
            ...
            Este contrato no tiene documentos asociados.
        </div>
    @else
        <div class="card">
